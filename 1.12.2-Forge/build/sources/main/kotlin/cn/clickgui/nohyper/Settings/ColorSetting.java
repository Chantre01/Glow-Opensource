...
public class ColorSetting extends Downward<ColorValue> {
    ...
    public void draw(int mouseX, int mouseY) {
        modulex = Client.instance.nohyp.mainx;
        moduley= Client.instance.nohyp.mainy;
        ...
        Fonts.SF.SF_17.SF_17.drawString(setting.getName(),modulex + 17 + pos.x,moduley + 38 + colory,new Color(200,200,200).getRGB());

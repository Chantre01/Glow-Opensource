...
object ClassProviderImpl : IClassProvider {
    ...
    override fun isCPacketConfirmTranscation(obj: Any?): Boolean = obj is PacketImpl<*> && obj.wrapped is CPacketConfirmTransaction
    ...
    override fun getVertexFormatEnum(type: WDefaultVertexFormats): IVertexFormat {
        return VertexFormatImpl(
                when (type) {
                    ...
                    WDefaultVertexFormats.POSITION_TEX_COLOR -> DefaultVertexFormats.POSITION_TEX_COLOR
                }
        )
    }

...
class ESP : Module() {
    @JvmField
    val modeValue = ListValue("Mode", arrayOf("Box", "OtherBox", "WireFrame", "2D", "Real2D", "Outline", "ShaderOutline", "ShaderGlow","datou"), "Box")
            ...
            if (entity != mc.thePlayer && EntityUtils.isSelected(entity, false)) {
                ...
                when (mode.toLowerCase()) {
                    ...
                    "datou" -> {
                        ...
                        RenderUtils.drawImage(classProvider.createResourceLocation("assets/minecraft/liquidbounce/ng.png"), (-8.0).toInt(), (-14.0).toInt(), 16, 16)
                        GL11.glPopMatrix();
                        GL11.glPopMatrix();
                    }
                }

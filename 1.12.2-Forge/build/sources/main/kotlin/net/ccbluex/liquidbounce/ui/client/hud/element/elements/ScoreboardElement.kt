...
class ScoreboardElement(
    ...
    override fun drawElement(): Border? {
        ...
        if (UIEffects.hudblur.get()) {
            ...
            GL11.glPushMatrix()
            RenderUtils.drawBlurRoundArea(
                (renderX + l1 - 7f).toFloat(),
                (renderY - 5f).toFloat(),
                maxWidth + 18f,
                maxHeight + fontRenderer.fontHeight + 10f,
                6f,
                UIEffects.hudblurradius.get().toFloat()
            )
            GL11.glPopMatrix()
            GL11.glTranslated(renderX, renderY, 0.0)
        }
        when (UIEffects.hudstyle.get()) {
            "CustomColor", "CustomShader", "CustomOutlined" -> {
                UIEffects.render(l1 - 7f, -5f, maxWidth + 18f, maxHeight + fontRenderer.fontHeight + 10f, 10f)
            }
            ...
            "OneTapV2" -> {
                ...
                RoundedUtil.drawRound(
                    ...
                    1.2f,
                    0.5f,
                    Color(UIEffects.Hudcolor.getValue())
                )
            }
        }
        ...
        return Border(-maxWidth.toFloat() - 10f, -5F, 9F, maxHeight.toFloat() + fontRenderer.fontHeight + 5)
    }

...
class FastUse : Module() {
    ...
    private val modeValue = ListValue("Mode", arrayOf("Instant", "NCP", "AAC", "Custom", "Vulcan", "Hypixel", "HytTest"), "NCP")
    ...
    fun onMotion(event: MotionEvent) {
        if(event.isPre()) {
            if (mc2.player!!.inventory.getCurrentItem() != null) {
                if (mc.gameSettings.keyBindUseItem.isKeyDown && (!stopMoving.get() || !MovementUtils.isMoving)) {

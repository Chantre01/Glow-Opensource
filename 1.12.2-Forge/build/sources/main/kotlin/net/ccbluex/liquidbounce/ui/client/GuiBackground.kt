...
class GuiBackground(val prevGui: IGuiScreen) : WrappedGuiScreen() {
    ...
    private lateinit var shaderButton: IGuiButton
    ...
    override fun initGui() {
        ...
        shaderButton = classProvider.createGuiButton(5, representedScreen.width / 2 - 100, representedScreen.height / 4 + 50 + 25 * 3, "Shader (${if (shader) "Flux" else "Rain"})")
        representedScreen.buttonList.add(shaderButton)
        ...
        when (button.id) {
            ...
            3 -> {
                ...
                try {
                    ...
                    val location = classProvider.createResourceLocation("fallen" + "/background.png")
            ...
            5 -> {
                shader = !shader
                shaderButton.displayString = "Shader (${if (shader) "Flux" else "Rain"})"
            }
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        Fonts.bold40.drawCenteredString("Background", this.representedScreen.width / 2F, representedScreen.height / 8F + 5F,
                4673984, true)

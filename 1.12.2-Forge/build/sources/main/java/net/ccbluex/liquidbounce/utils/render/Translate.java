...
public final class Translate {
    ...
    public void translate(float targetX, float targetY) {
        x = cn.utils.render.AnimationUtils.lstransition(x, targetX, 0.0);
        y = cn.utils.render.AnimationUtils.lstransition(y, targetY, 0.0);
    }
    public void translate(float targetX, float targetY, double speed) {
        x = cn.utils.render.AnimationUtils.lstransition(x, targetX, speed);
        y = cn.utils.render.AnimationUtils.lstransition(y, targetY, speed);
    }

...
public class ModulesConfig extends FileConfig {
    ...
    protected void loadConfig() throws IOException {
        ...
        while(entryIterator.hasNext()) {
            ...
            if(module != null) {
                ...
                module.setAutoDisable(EnumAutoDisableType.valueOf(jsonModule.get("AutoDisable").getAsString().toUpperCase()));
    ...
    protected void saveConfig() throws IOException {
        ...
        for (final Module module : LiquidBounce.moduleManager.getModules()) {
            ...
            jsonMod.addProperty("AutoDisable", String.valueOf(module.getAutoDisable()).toUpperCase());

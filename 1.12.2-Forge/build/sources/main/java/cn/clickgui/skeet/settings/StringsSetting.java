...
public class StringsSetting extends Downward<ListValue> {
    ...
    public void draw(int mouseX, int mouseY) {
        ...
        FontLoaders.NL18.drawString(((ListValue)this.setting).getName(), (float)(this.mainx + 17) + this.pos.x, (float)(this.mainy + 38 + this.y),new Color(130,140,150).getRGB());
        ...
        FontLoaders.NL16.drawString(((ListValue)this.setting).get().toString(), (float)(this.mainx + 93) + this.pos.x, (float)(this.mainy + 38 + this.y), new Color(130,140,150).getRGB());
        ...
        if (((ListValue)this.setting).openList) {
            ...
            for (String option : var5) {
                ...
                FontLoaders.NL16.drawString(option, (float) (this.mainx + 93) + this.pos.x, (float) (this.mainy + 38 + 12 + this.y + ((ListValue) this.setting).getModeListNumber(String.valueOf(option)) * 12), new Color(130, 140, 150).getRGB());

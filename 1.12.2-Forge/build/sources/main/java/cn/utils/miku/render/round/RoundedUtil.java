package cn.utils.miku.render.round;
...
import static cn.utils.miku.render.RenderUtil.resetColor;

public class RoundedUtil {
    Minecraft mc = Minecraft.getMinecraft();
    public static ShaderUtil roundedShader = new ShaderUtil("roundedRect");
    public static ShaderUtil roundedOutlineShader = new ShaderUtil("liquidbounce/Shaders/roundRectOutline.frag");
    private static final ShaderUtil roundedTexturedShader = new ShaderUtil("liquidbounce/Shaders/roundRectTextured.frag");
    ...
    public static void drawSmoothRound(float left, float top, float right, float bottom, float radius, Color color) {
        ...
        // LiquidBounce RenderUtils = This RoundedUtil
...
// it sk1dded in LiquidBounce RenderUtils

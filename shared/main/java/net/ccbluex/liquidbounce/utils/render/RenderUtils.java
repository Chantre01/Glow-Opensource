...
import cn.utils.render.BloomUtil;
...
public final class RenderUtils extends MinecraftInstance {
    ...
    public static void drawRoundedRectfix(float x, float y, float width, float height, float radius, int color) {
        RenderUtils.drawRoundedRect2(x, y, x + width, y + height, radius, 20, color);
    }
    ...
    public static void drawBlurRoundArea(float x, float y, float width, float height, float radius, float BlurStrength) {

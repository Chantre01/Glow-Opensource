...
import cn.manager.CombatListener
...
object LiquidBounce {
    ...
    // Client information
    const val CLIENT_NAME = "Glow"
    const val CLIENT_VERSION = "Preview 1.56"
    const val CLIENT_CREATOR = "LemonItexX"
    const val MINECRAFT_VERSION = Backend.MINECRAFT_VERSION
    const val CLIENT_CLOUD = "https://gitee.com/LemonHaikea/Glow-Client/tree/master"
    ...
    fun startClient() {
        ...
        eventManager.registerListener(AutoDisable)
        ...
        // ClickGUI
        Client.instance.otc = OtcClickGUi()
        Client.instance.skeet = HyperGui()
        //Client.instance.notificationManager = NotificationManager()
        //Client.instance.jelloClick = myJello()
        //Client.instance.fluxotc = click()
        //Client.instance.eV0 = EV0Clickgui()
        Client.instance.nohyp = hyperGui()
        //Client.instance.fancy = fancyGui()
        //Client.instance.rich = CSGOGui()
        //Client.instance.newUI = ClickGuiScreen()
        //Client.instance.alone = UI()
        //Client.instance.flux = NewClickGUI()
        clickGui = ClickGui()
        ...
        Display.setTitle("$CLIENT_NAME $CLIENT_VERSION | By LemonIteXX")
        isStarting = false

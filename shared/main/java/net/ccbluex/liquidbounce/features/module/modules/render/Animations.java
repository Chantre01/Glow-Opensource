...
public class Animations extends Module {
    ...
    public static final ListValue Sword = new ListValue("Sword", new String[]{"Old", "1.7", "WindMill", "Push", "Smooth", "SigmaOld", "BigGod", "Jello","Flux","Rotate360","SideDown","Test2","ETB","SigmaNew","Exhibition","Test"}, "1.7");
    ...
    public static final ListValue tabAnimations = new ListValue("Tab-Animation", new String[]{"None", "Zoom", "Hlide","VSlide","HVSlide"}, "Zoom");
    @Override

...
public class colorSetting extends Downward<ColorValue> {
    ...
    public void draw(int mouseX, int mouseY) {
        modulex = Client.instance.skeet.mainx;
        moduley= Client.instance.skeet.mainy;
        ...
        FontLoaders.NL18.drawString(setting.getName(),modulex + 17 + pos.x,moduley + 38 + colory,new Color(130,140,150).getRGB());
        ...
        if (colorValue.isExpanded()) {
            ...
            RenderUtil.drawBorderedRect(expandedX, expandedY,expandedX + expandedWidth, expandedY+expandedHeight + 70,1, new Color(0,0,0,0).getRGB(),new Color(5,23,37).getRGB());
    ...
    public boolean isHovered(int mouseX, int mouseY) {
        return mouseX >=pos.x + modulex + 153 && mouseX <=pos.x + modulex + 153 + 13 && mouseY >= colory + moduley + 38 + 2 && mouseY <=(colory + moduley + 38 - 0.5 + 8);
    }
